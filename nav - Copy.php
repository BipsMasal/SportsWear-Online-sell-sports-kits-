    ...
    <div class="site-header">
				<div class="container">
					<a href="index.php" id="branding">
						...
						<div class="logo-text">
							<h1 class="site-title">Gameology</h1>
							<small class="site-description">For Gamers</small>
						</div>
					</a> <!-- #branding -->

					<div class="right-section pull-right">
					<?php echo "<a href='#' class='cart'><i class='icon-cart'></i> 0 items in cart </a>" ?>
					...
					<div class="main-navigation">
						...
						<ul class="menu">
                            <?php if($_SERVER['PHP_SELF']=='/ron/index.php'){
							...
							?>
							<?php if($_SERVER['PHP_SELF']=='/ron/pc.php'){
							...
							?>
							<?php if($_SERVER['PHP_SELF']=='/ron/own.php'){
								echo "<li class='menu-item current-menu-item' ><a href='#'>Play</a></li> ";
							}
							else{
								echo "<li class='menu-item' ><a href='#'>Play</a></li> ";
							}
